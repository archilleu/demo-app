<template>
  <div class="page-container">
    ...
    >
      ...
      <el-table-column prop="name" header-align="center" align="center" width="80" label="名称"></el-table-column>
          ...
          <el-row>
            ...
            <el-col :span="2">
              <el-tooltip placement="top" effect="light" style="padding: 10px;">
                <div slot="content">
                  <p>URL格式：</p>
                  <p>1.常规业务开发的功能URL，如用户管理，compoments目录下页面路径为 /Sys/User, 此处填写 /sys/user。</p>
